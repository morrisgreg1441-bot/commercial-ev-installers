---
to: sales@48fourservices.com
to_name: 
subject: You're listed in South East — want the top slot?
slug: 48-four-contract-services-cr0-4rr
prospect_rank: 64
status: ready
---
Hi there,

48 Four Contract Services is one of 203 OZEV-authorised commercial installers we list across South East on the new commercial-only directory at https://commercial-ev-installers.pages.dev. Alphabetically you're near the top of the South East list (position 1 of 203), just above A & E Builders Ltd — but the #1 slot still sits above you.
