...
to: admin@instia.net
to_name: 
subject: OZEV register entry — quick note on Cheam visibility
slug: instia-ltd-sm2-7aj
prospect_rank: 95
status: ready
---
Hi there,

Instia Ltd is one of 203 OZEV-authorised commercial installers we list across South East on the new commercial-only directory at https://commercial-ev-installers.pages.dev. Alphabetically your listing sits between IMSERV Europe Ltd and Inyo Energy — position 104 of 203 — which is fine, but not where click-throughs concentrate.

I'm opening a Featured slot for Cheam and the South East region page: £99 one-time for 12 months. Founder rate, capped at 25 sales or 30 June 2026, whichever first. Pins you to #1 on the Cheam page, the South East page, and the relevant commercial-service pages, with a FEATURED PARTNER badge.
